...
public class MainActivity extends Activity {
    ...
    private Button mStartButton, mGithubButton, mHackButton;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mHackButton = (Button) findViewById(R.id.hack_btn);
        ...
        mHackButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Toast.makeText(
                    MainActivity.this,
                    "current alloc = " + LinearAllocFix.getInstance().current() + " , hack = "
                            + LinearAllocFix.getInstance().hack(), Toast.LENGTH_SHORT).show();
            }
        });
    ...
    class PatchThread extends Thread {
        ...
        public void run() {
            ...
            if (!TextUtils.isEmpty(oldApkSource)) {
                ...
                int patchResult = PatchUtils.patch(Constants.OLD_APK_PATH, Constants.NEW_APK_PATH,
        ...
        public void handleMessage(Message msg) {
            ...
            switch (what) {
                ...
                case 0:
                    ...
                    if (!TextUtils.isEmpty(signatureNew) && !TextUtils.isEmpty(signatureSource)
                            && signatureNew.equals(signatureSource)) {
                        Toast.makeText(mContext, "新apk已合成成功：" + Constants.NEW_APK_PATH,
                            Toast.LENGTH_LONG).show();
                        ...
                        Toast.makeText(mContext, "新apk已合成失败，签名不一致", Toast.LENGTH_LONG).show();
                    }
                    break;
                default:
